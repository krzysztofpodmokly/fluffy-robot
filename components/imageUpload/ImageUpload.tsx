...
const ImageUpload = () => {
  ...
  return <>
    <div className="flex items-center ml-3">
      {previewImage ? <Image className="block rounded-full mr-4" src={previewImage} width="70" height="30" alt="Current Avatar" /> : <Image className="block rounded-full mr-4" src="/default-avatar.jpg" width="50" height="10" alt="Default Avatar" />}
      <div className="text-center space-y-2 sm:text-left">
        <div className="grid justify-items-start space-y-0.5">
          ...
          <input id="file-input" className='hidden file-input file-input-ghost w-full max-w-xs text-xs text-blue-300' type="file" accept='image/*' onChange={uploadFile} />
